...
- (id)initWithURL:(NSURL *)newURL
{
    ...
    NSRecursiveLock *tmpLock = [[NSRecursiveLock alloc] init];
    self.cancelledLock = tmpLock;
    [tmpLock release];
...
- (void)requestStarted
{
    ...
    @catch (NSException *exception) {
        NSLog(@"requestStarted:%@",exception.reason);
    }
...
- (void)requestReceivedResponseHeaders:(NSMutableDictionary *)newResponseHeaders
{
    ...
    @catch (NSException *exception) {
        NSLog(@"requestReceivedResponseHeaders:%@",exception.reason);
    }
...
+ (NSString *)defaultUserAgentString
{
    ...
    NSString *developmentVersionNumber = marketingVersionNumber;
...
+ (void)recordBandwidthUsage
{
	...
	averageBandwidthUsedPerSecond = totalBytes/(float)measurements;
}
